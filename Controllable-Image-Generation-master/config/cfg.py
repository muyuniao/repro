...
class BaseConfig(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--sub_iter', default=-1, type=int, help='Number of training iterations')
        ...
        self.parser.add_argument("--cls_only", action='store_true')


    def initialize(self, fixed=None, show=False):
        # print(fixed)
